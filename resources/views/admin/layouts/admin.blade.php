...
<body>
        ...
        get_users();
            ...
            function get_users(output = '')
            {
                $.ajax({
                    ...
                    {
                        $('#get_users').text(data.total_data);
                    }
                })
            }
        });
    ...
    <script>
        ...
        get_categories();
            ...
            function get_categories(output = '')
            {
                $.ajax({
                    ...
                    success:function(data)
                    {
                        $('#get_categories').text(data.total_data);
                    }
                })
            }
        });
